!function (e) { if ("object" == typeof exports) module.exports = e(); else if ("function" == typeof define && define.amd) define(e); else { var o; "undefined" != typeof window ? o = window : "undefined" != typeof global ? o = global : "undefined" != typeof self && (o = self), o.CircularMigrationPlot = e() } }(function () {
  var define, module, exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); throw new Error("Cannot find module '" + o + "'") } var f = n[o] = { exports: {} }; t[o][0].call(f.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, f, f.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (_dereq_, module, exports) {
      ...
      module.exports = function (data, config) {
        ...
        config.animationDuration = config.animationDuration || 500;
        ...
        // 各地方の色を指定できるようにするための設定
        var regionColors = {
          "北海道地方": "#19448e", // 例: 北海道地方の色
          "東北地方": "#309dcf",   // 例: 東北地方の色
          "関東地方": "#30a039",   // 例: 関東地方の色
          "中部地方": "#ffca36",   // 例: 中部地方の色
          "近畿地方": "#9468ba",   // 例: 近畿地方の色
          "中国地方": "#e278c0",   // 例: 中国地方の色
          "四国地方": "#ec9027",   // 例: 四国地方の色
          "九州・沖縄地方": "#d52a2e" // 例: 九州・沖縄地方の色
        };
        function arcColor(d) {
          // 地方に属する都道府県の色を設定
          var regionName = data.names[d.region];
          var color = regionColors[regionName] || colors(d.region); // 地方の色を使用
          if (d.region === d.id) {
            return color; // 地方の色を返す
          }

          var hsl = d3.hsl(color);
          var r = [hsl.brighter(0.5), hsl.darker(1.5), hsl, hsl.brighter(0.5), hsl.darker(0.75)];
          return r[(d.id - d.region) % 5].toString();
        }
